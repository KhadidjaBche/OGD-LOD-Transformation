...
<body>
	...
	<center>
		...
		<form method=post action=UploadDatasets enctype="multipart/form-data">
		<%
		/************Connect to the database and insert the selected options to the database*************/
		%>
			<center>
				<label for="dropdown1">Choose the domain of your data from
					the following drop-down list: </label> <br> <br> <br> <input
					type=text1 list=browsers1 name=dropdown1>
				...
				<br> <br> <br> <br> <br> <br> <label
					for="myfile">Select files to be transformed to linked data:</label>

				<br> <br> <br> <input type="file" id="myfile"
					name="myfile" multiple><br>
				<br> <br> <br> <br>
				
				<label for="dropdown">Choose the topic of the dataset: </label> <br> <br> <br> <input
					type=text list=browsers name=dropdown>
				<datalist id=browsers>
					...
					<option>Education
					<option>Environment
					<option>Crime and justice
					<option>Social Networking
				</datalist> <br> <br> <br> <br>
				
				<label>Name the generated file: </label> <br><br><input style="height:40px; width:250px;" type="text" name="Name" />
				                 <br> <br> <br> <br>
				
				<label>Insert the title: </label> <br><br><input style="height:40px; width:250px;" type="text" name="title" />
				                 <br> <br> <br> <br>
				               <label>Describe the dataset: </label> <br><br> <input style="height:140px; width:300px;" type="text" name="description" />  <br><br> <br>
				    <br>      
