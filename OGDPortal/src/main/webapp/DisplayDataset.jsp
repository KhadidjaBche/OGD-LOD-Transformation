...
<%
        ...
        /* Select the dataset whith specifying the topic and the dataset         */
        /*************************************************************************/
...
<div class="card" style="width: 20rem;">
			<div class="card-body">
				...
				<p class="card-text">
					&nbsp;&nbsp;Access the dataset: <a href="<% /*insert the file*/%>" download="<% /*insert the name of the file*/%>"><% /*insert the format of the dataset*/%></a>
				</p>
