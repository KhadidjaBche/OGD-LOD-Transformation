	...
	<center>
		<br> <br> <br>
			...
			<div class="card-body">
				...
				<h5 class="card-title">Population statistics in Algeria&nbsp;&nbsp;&nbsp;&nbsp;&#127757;</h5>
				<h6 class="card-subtitle mb-2 text-muted"></h6>
				<p class="card-text">The population percentage in the generated
...
– 2019.
– 2020.
 percentage (which represents the percentage corresponding to the statistic done). … Continued </p>
				<p class="card-text">
					<small class="text-muted">&#128198;&nbsp;&nbsp;Date
						creation <jsp:useBean id="now2" scope="page" class="java.util.Date"/>
        ${now}</small>
				</p>
				<div class="buttons px-4 mt-0">
				...
				<div class="buttons px-4 mt-0">
					<button class="btn btn-warning btn-block rating-submit" onclick="document.location='PublishedService.jsp'">&#9776;&nbsp;&nbsp;
