...
public class LifeSciencesXlsToRDF {
    ...
    private static void setPrefixes( Model m ) {
        ...
        m.setNsPrefix( "go", "http://amigo.geneontology.org/amigo/term/GO:0032571" );
        m.setNsPrefix( "doid", "http://purl.obolibrary.org/obo/doid.owl" );
